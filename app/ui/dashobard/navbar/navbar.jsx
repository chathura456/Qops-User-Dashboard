...
const devOpsTerms = [
  "Kubernetes", "Docker", "CI/CD", "Jenkins", "Ansible", "Terraform", 
  "GitOps", "Monitoring", "Prometheus", "Grafana", "AWS", "Azure", 
  "GCP", "Helm", "Agile", "DevSecOps", "Microservices", "Containerization", 
  "IaC", "Observability", "Logging", "Scaling", "Automation"
];
